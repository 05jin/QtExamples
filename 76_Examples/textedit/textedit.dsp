...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\textedit" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\textedit" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
USERDEP_textedit=""$(QTDIR)\bin\moc.exe""

!IF  "$(CFG)" == "textedit - Win32 Release"

# Begin Custom Build - Moc'ing textedit.h...
InputPath=.\textedit.h


BuildCmds= \
	$(QTDIR)\bin\moc textedit.h -o tmp\moc\release_mt_shared\moc_textedit.cpp \
...
SOURCE=editcopy.xpm
USERDEP_editcopy.xpm="editcopy.xpm"\
"editcut.xpm"\
"editpaste.xpm"\
"editredo.xpm"\
"editundo.xpm"\
...
InputPath=.\editcopy.xpm

"qmake_image_collection.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	$(QTDIR)\bin\uic -embed textedit -f images.tmp -o qmake_image_collection.cpp
...
SOURCE=textcenter.xpm
# End Source File
# Begin Source File

SOURCE=textitalic.xpm
# End Source File
# Begin Source File

SOURCE=textjustify.xpm
# End Source File
# Begin Source File
...
SOURCE=textright.xpm
# End Source File
# Begin Source File

SOURCE=textunder.xpm
# End Source File
