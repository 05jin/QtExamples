...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\network\clientserver\server" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\network\clientserver\server" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
SOURCE=tmp\moc\release_mt_shared\server.moc
USERDEP_tmp_moc_release_mt_shared_server=".\server.cpp" "$(QTDIR)\bin\moc.exe"

!IF  "$(CFG)" == "server - Win32 Release"

# Begin Custom Build - Moc'ing server.cpp...
InputPath=.\tmp\moc\release_mt_shared\server.moc

"tmp\moc\release_mt_shared\server.moc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	$(QTDIR)\bin\moc server.cpp -o tmp\moc\release_mt_shared\server.moc
