...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\network\mail" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\network\mail" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
USERDEP_composer=""$(QTDIR)\bin\moc.exe""

!IF  "$(CFG)" == "mail - Win32 Release"

# Begin Custom Build - Moc'ing composer.h...
InputPath=.\composer.h


BuildCmds= \
	$(QTDIR)\bin\moc composer.h -o tmp\moc\release_mt_shared\moc_composer.cpp \

"tmp\moc\release_mt_shared\moc_composer.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
...
USERDEP_smtp=""$(QTDIR)\bin\moc.exe""

!IF  "$(CFG)" == "mail - Win32 Release"

# Begin Custom Build - Moc'ing smtp.h...
InputPath=.\smtp.h


BuildCmds= \
	$(QTDIR)\bin\moc smtp.h -o tmp\moc\release_mt_shared\moc_smtp.cpp \

"tmp\moc\release_mt_shared\moc_smtp.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
...
SOURCE=tmp\moc\release_mt_shared\moc_composer.cpp
# End Source File
# Begin Source File

SOURCE=tmp\moc\release_mt_shared\moc_smtp.cpp
# End Source File
