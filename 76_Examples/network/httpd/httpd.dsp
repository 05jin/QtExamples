...
!MESSAGE 
!MESSAGE "httpd - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "httpd - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\network\httpd" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\network\httpd" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
SOURCE=tmp\moc\release_mt_shared\httpd.moc
USERDEP_tmp_moc_release_mt_shared_httpd=".\httpd.cpp" "$(QTDIR)\bin\moc.exe"

!IF  "$(CFG)" == "httpd - Win32 Release"

# Begin Custom Build - Moc'ing httpd.cpp...
InputPath=.\tmp\moc\release_mt_shared\httpd.moc

"tmp\moc\release_mt_shared\httpd.moc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	$(QTDIR)\bin\moc httpd.cpp -o tmp\moc\release_mt_shared\httpd.moc
