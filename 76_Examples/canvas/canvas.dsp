...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\canvas" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "$(QTDIR)\include" /I "C:\Qt\3.3.1\examples\canvas" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.1\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
USERDEP_canvas=""$(QTDIR)\bin\moc.exe""

!IF  "$(CFG)" == "canvas - Win32 Release"

# Begin Custom Build - Moc'ing canvas.h...
InputPath=.\canvas.h


BuildCmds= \
	$(QTDIR)\bin\moc canvas.h -o tmp\moc\release_mt_shared\moc_canvas.cpp \

"tmp\moc\release_mt_shared\moc_canvas.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
...
SOURCE=tmp\moc\release_mt_shared\moc_canvas.cpp
# End Source File
